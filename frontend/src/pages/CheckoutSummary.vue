<template>
	...
	<div>
		<div v-if="!paymentStatus">
			<div v-if="ticketType.data" class="min-h-screen bg-gray-50 py-3 md:py-6 px-3 md:px-4">
				<div class="max-w-5xl mx-auto">
					<div class="grid grid-cols-1 lg:grid-cols-2 gap-3 md:gap-4">
						<div class="space-y-3">
							...
							>
								<h2 class="text-base md:text-lg font-semibold text-red-600 mb-3">
									Booking Summary
								</h2>
							...
							>
								...
								<div class="space-y-2.5">
									...
									>
										...
										>
											{{ attendeeBooking.getBookingData().attendees.length }}
										</span>
									</div>
		...
		<div v-else class="p-10 min-h-32 max-w-3xl mx-auto my-auto">
			<PaymentStatus
