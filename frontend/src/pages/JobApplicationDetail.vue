...
useHead({
	title: "Job Application Details | Tanzania Red Cross ",
	meta: [
		{
			name: "description",
			content:
				"View and manage your job application details for Tanzania Red Cross opportunities. Track your application status and updates.",
		},
	],
});
</script>
