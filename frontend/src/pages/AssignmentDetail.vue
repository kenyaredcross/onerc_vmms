...
useHead({
	title: "Project Assignment Details | Tanzania Red Cross",
	meta: [
		{
			name: "description",
			content:
				"View details for your assigned Tanzania Red Cross project, including progress, timeline, and assignment decision (Accept/Reject).",
		},
	],
});
</script>
