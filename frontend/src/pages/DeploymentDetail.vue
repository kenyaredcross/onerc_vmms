...
useHead({
	title: "Deployment Assignment Details | Gambia Red Cross Society",
	meta: [
		{
			name: "description",
			content:
				"View details for your assigned Gambia Red Cross Society deployment, including progress, timeline, and assignment decision (Accept/Reject).",
		},
	],
});
</script>
