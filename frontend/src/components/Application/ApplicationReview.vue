<template>
	<div class="space-y-6">
		<CollapsibleSection :title="__('Personal Details')">
		...
		<CollapsibleSection :title="__('Contact & Location')">
			<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
				<Link
					doctype="County"
					v-model="form.county"
		...
		<CollapsibleSection :title="__('Education & Qualifications')">
		...
		<CollapsibleSection :title="__('Work Experience & References')">
			<div class="grid grid-cols-1 gap-6">
				<ChildTable
		...
		<CollapsibleSection :title="__('Additional Questions')">
			<div class="space-y-8">
				<div
